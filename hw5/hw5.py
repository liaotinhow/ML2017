...
def main():
    ...
    model.add(Embedding(num_words,
                        ...
                        trainable=False))
    model.add(GRU(128,activation='sigmoid',dropout=0.1))
    ...
    model.save('model.h5')
    with open('taglist.pickle', 'wb') as handle:
        pickle.dump(taglist, handle, protocol=pickle.HIGHEST_PROTOCOL)
    with open('max_article_length.pickle', 'wb') as handle:
        pickle.dump(max_article_length, handle, protocol=pickle.HIGHEST_PROTOCOL)
