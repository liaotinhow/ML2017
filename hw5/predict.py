...
def main():
    ...
    with open('taglist.pickle', 'rb') as handle:
        tag_list = pickle.load(handle)
    with open('max_article_length.pickle', 'rb') as handle:
        max_article_length = pickle.load(handle)
    ...
    model = load_model('model_2.h5', custom_objects={'f1_score': f1_score})
